...
const user = {
  ...
  printDetails: function () {
    ...
    console.log(
      `Name: ${this.name}, City: ${this.address.city}, Bank: ${this.bankdetails.name}, Account No: ${this.bankdetails.account.no}`
    );
  },
};
...
console.log(
  'cibil score : ',
  user?.bankdetails?.cibil?.score ?? 'CIBIL details not available'
); // doesn't throw error, but returns undefined, so we use nullish coalescing operator to provide a default value
